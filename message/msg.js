...
const exif = new Exif()
const Lolkey = "472a84cba7fd70601a54c767"
//━─━─━─━─━─━─━─━─━─━─━─━─━─⟤ 𝗗𝗕 𝗚𝗔𝗠𝗘 ⟥─━─━─━─━─━─━─━─━─━─━─━─━
let tictactoe = [];
let tebakgambar = []
let caklontong = []
...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		let { ownerNumber, botName, gamewaktu, Lolkey, limitCount } = setting
		...
		const buttonsDefault = [
		    { urlButton: { displayText: `TikTok`, url : `${setting.youtubeOwner}` } },
...
//━─━─━─━─━─━─━─━─━─━─━─━─━─⟤ 𝗥𝗔𝗡𝗗𝗢𝗠 𝗠𝗘𝗡𝗨 ⟥─━─━─━─━─━─━─━─━─━─━─━─━
            ...
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}wallsatanic`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Wallpaper Satanic", image: { url: `https://christian-id-api.herokuapp.com/api/wallpaper/satanic?apikey=IzumiBot` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'wallquote':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}wallquote`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Wallpaper Quote", image: { url: `https://christian-id-api.herokuapp.com/api/wallpaper/katakata?apikey=IzumiBot` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'wallanime':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}wallanime`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Wallpaper Anime", image: { url: `https://christian-id-api.herokuapp.com/api/wallpaper/anime?apikey=IzumiBot` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'wallgaming':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}wallgaming`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Wallpaper Gaming", image: { url: `https://christian-id-api.herokuapp.com/api/wallpaper/gaming?apikey=IzumiBot` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'wallhekel':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}wallhekel`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Wallpaper Hekel", image: { url: `https://christian-id-api.herokuapp.com/api/wallpaper/hekel?apikey=IzumiBot` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
//━─━─━─━─━─━─━─━─━─━─━─━─━─⟤ 𝗦𝗘𝗔𝗥𝗖𝗛 𝗠𝗘𝗡𝗨 ⟥─━─━─━─━─━─━─━─━─━─━─━─━
...
case prefix+'patrick':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/patrick?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'lonet':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/lonte?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'lidi':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/manusia-lidi?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'kucing':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kucing?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'sponbob':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/sponsbob?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'kawansponbob':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kawan-sponsbob?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'popoci':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/popoci?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'meow':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/meow?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'menjamet':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/menjamet?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'tyni':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/tyni?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'gojosatoru':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/gojosatoru?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'hopeboy':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/hope-boy?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'doge':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/doge?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'dinokuning':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/dyno-kuning?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'nicholas':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/nicholas?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'krrobot':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kr-robot?apikey=dhmDlD5x`}}, {quoted: msg})
break
case prefix+'jiisho':
reply(mess.wait)
conn.sendMessage(from, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/jisoo?apikey=dhmDlD5x`}}, {quoted: msg})
break

//━─━─━─━─━─━─━─━─━─━─━─━─━─⟤ 𝗖𝗘𝗖𝗔𝗡 𝗠𝗘𝗡𝗨 ⟥─━─━─━─━─━─━─━─━─━─━─━─━

case prefix+'cecanvietnam':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecanvietnam`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Vietnam", image: { url: `https://api.zeeoneofc.xyz/api/cecan/vietnam?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecanmalaysia':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecanmalaysia`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Malaysia", image: { url: `https://api.zeeoneofc.xyz/api/cecan/malaysia?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecanindonesia':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecanindonesia`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Indonesia", image: { url: `https://api.zeeoneofc.xyz/api/cecan/indonesia?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecankorea':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecankorea`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Korea", image: { url: `https://api.zeeoneofc.xyz/api/cecan/korea?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecanjapan':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecanjapan`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Japan", image: { url: `https://api.zeeoneofc.xyz/api/cecan/japan?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecanthailand':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecantailand`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan Thailand", image: { url: `https://api.zeeoneofc.xyz/api/cecan/thailand?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
case prefix+'cecanchina':
            if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            reply(mess.wait)
            var but = [{buttonId: `${prefix}cecanchina`, buttonText: { displayText: "Next Photo➲" }, type: 1 }]
				conn.sendMessage(from, { caption: "Random Cecan China", image: { url: `https://api.zeeoneofc.xyz/api/cecan/china?apikey=dhmDlD5x` }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
			    limitAdd(sender, limit)
				break
